  ...
  const versions: Version[] = [
    ...
    },
    {
      ...
      changes: [
        ...
        { field: 'income.employerId',     oldValue: '',  newValue: '47-2381942' },
        { field: 'income.employerName',   oldValue: '',  newValue: 'Bing Equipment' },
        { field: 'income.streetAddress',  oldValue: '',  newValue: '3833 Soundtech Ct SE' },
        { field: 'income.city',           oldValue: '',  newValue: 'Kentwood' },
        { field: 'income.state',          oldValue: '',  newValue: 'MI' },
        { field: 'income.zip',            oldValue: '',  newValue: '49512' },
        { field: 'income.w2Wages',        oldValue: 0,   newValue: 78420 },
        { field: 'income.fedTaxWithheld', oldValue: 0,   newValue: 9843 },
        { field: 'income.ssWages',        oldValue: 0,   newValue: 78420 },
        { field: 'income.ssTaxWithheld',  oldValue: 0,   newValue: 4862 },
        // Interest & Dividends — 8 fields
